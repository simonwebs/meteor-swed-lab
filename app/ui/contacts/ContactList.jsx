...
import { ContactsCollection } from '../../access/ContactsCollection';
      ...
      <li className="py-4 flex items-center justify-between space-x-3">
        <div className="min-w-0 flex-1 flex items-center space-x-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
            <p className="text-sm font-medium text-gray-500 truncate">{contact.subject}</p>
            </div>
          <div className="min-w-0 flex-1">
            <p className="text-sm font-medium text-gray-500 truncate">{contact.message}</p>
          </div>
          <div>
            <a
              href="#"
